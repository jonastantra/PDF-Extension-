        ...
        if (error.isRestricted) {
            webpageInfo.innerHTML = `
                <div class="webpage-restricted">
                    ...
                    <p>Las páginas del ${error.pageType || 'sistema'} no se pueden capturar por seguridad.</p>
                    <span class="webpage-restricted-hint">Navega a una página web normal para convertirla a PDF.</span>
                </div>
            `;
        } else {
            webpageInfo.innerHTML = `
...
async function runMerge() {
    ...
    try {
        ...
        showStatus('¡PDF unido con éxito!', 'success');
    } catch (error) {
...
async function runCreate() {
    ...
    try {
        ...
        showStatus('¡PDF creado con éxito!', 'success');
    } catch (error) {
        showStatus('Error: ' + error.message, 'error');
    } finally {
        stopProcessing();
...
async function runSplit() {
    ...
    try {
        ...
        downloadFile(blob, filename);
        showStatus('¡PDF dividido con éxito!', 'success');
    } catch (error) {
        showStatus('Error: ' + error.message, 'error');
    } finally {
        stopProcessing();
...
async function runRotate() {
    ...
    try {
        ...
        showStatus('¡PDF rotado con éxito!', 'success');
    } catch (error) {
        showStatus('Error: ' + error.message, 'error');
    } finally {
        stopProcessing();
...
async function runWatermark() {
    ...
    try {
        ...
        showStatus('¡Marca de agua aplicada!', 'success');
    } catch (error) {
        showStatus('Error: ' + error.message, 'error');
    } finally {
        stopProcessing();
...
async function runCompress() {
    ...
    try {
        ...
        showStatus(`¡Comprimido! Ahorro: ${result.percentage}%`, 'success');
    } catch (error) {
        showStatus('Error: ' + error.message, 'error');
    } finally {
        stopProcessing();
